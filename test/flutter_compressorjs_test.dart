...
void main() {
  final FlutterCompressorjsPlatform initialPlatform = FlutterCompressorjsPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterCompressorjsPlatform fakePlatform = MockFlutterCompressorjsPlatform();
